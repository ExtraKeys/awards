		...
		VStack {
			Group {
				...
				Text("Unmatched foresight, consistency, competency, innovation, and support.")
					...
					.padding(.vertical, 0)
				Image(uiImage: UIImage(named: "Image 2.png") ?? .init())
					.renderingMode(.original)
					.resizable()
					.aspectRatio(contentMode: .fit)
					.padding(.top, 10)
					.frame(width: 266, height: 290)
					.clipped()
					.shadow(color: Color(.displayP3, red: 154.52/255, green: 207.15/255, blue: 249.66/255), radius: 17, x: 0, y: 4)
				Text("TWEETBOT")
					...
					.padding(.top, 0)
					.lineSpacing(0)
					.foregroundColor(Color(.displayP3, red: 84.58/255, green: 143.16/255, blue: 243.41/255))
					.shadow(color: Color(.displayP3, red: 175.4/255, green: 223.27/255, blue: 251.75/255), radius: 6, x: 0, y: 2)
					.fixedSize(horizontal: true, vertical: true)
				Text("Misters Paul Haddad & Mark Jardine")
