//
//  UniversalClackerAwardCopy.swift
//  MyProject
//
...
struct UniversalClackerAwardCopy: View {
    var body: some View {
		VStack {
			Group {
				...
				Image(uiImage: UIImage(named: "Image 1.png") ?? .init())
					...
					.clipped()
					.shadow(color: Color(.displayP3, red: 59.57/255, green: 113.86/255, blue: 212.87/255), radius: 17, x: 0, y: 4)
				Text("MASTODON")
					...
					.padding(.top, 0)
					.lineSpacing(0)
					.foregroundColor(Color(.displayP3, red: 60.1/255, green: 116.32/255, blue: 212.95/255))
					.shadow(color: Color(.displayP3, red: 71.37/255, green: 133.62/255, blue: 222.62/255).opacity(0.84), radius: 6, x: 0, y: 2)
					.fixedSize(horizontal: true, vertical: true)
				Text("For iPhone")
					.italic()
					.frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .top)
					...
					.lineSpacing(0)
					.foregroundColor(Color(.displayP3, red: 60.1/255, green: 116.32/255, blue: 212.95/255))
					.shadow(color: Color(.displayP3, red: 71.37/255, green: 133.62/255, blue: 222.62/255).opacity(0.84), radius: 0, x: 0, y: 1)
					.fixedSize(horizontal: true, vertical: true)
				Text("Eugen Rochko & Contributors")
...
struct UniversalClackerAwardCopy_Previews: PreviewProvider {
    static var previews: some View {
        UniversalClackerAwardCopy()
    }
}
